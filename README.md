...
- `SCG014` Immediate server shutdown configured in production
- `SCG015` Wildcard Actuator CORS origin configured in production
...
individual SCG001–SCG015 rules, or use **Enable all rules**, **Disable all rules**, and
